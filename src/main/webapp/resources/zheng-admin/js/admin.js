...
$(function() {
    ...
    // 切换系统
    $('.switch-enterprises').click(function () {
        var enterpriseId = $(this).attr('enterpriseId');
        var enterpriseName = $(this).attr('enterpriseName');
        //更改企业的menus
        // $('.system_menus').hide(0, function () {
        //     $('.system_' + enterpriseId).show();
        //
        // });
        ...
        $('body').attr("id", enterpriseName);
        $('#enterprise_name').text(enterpriseName);
        $.cookie('upms-enterpriseId', enterpriseId);
        $.cookie('upms-enterpriseName', enterpriseName);
    ...
    // 显示cookie菜单
    var enterpriseId = $.cookie('upms-enterpriseId') || -1;

    if (enterpriseId != -1){
        var enterpriseName = $.cookie('upms-enterpriseName');
		// $('.system_menus').hide(0, function () {
		// 	$('.system_' + enterpriseId).show();
		// });
		$('body').attr('id', enterpriseName);
